...
description: Manage notes using the nb CLI. Use when the user refers to "note" or "nb" for creating, editing, searching, listing notes, or managing todos.
---

# Notes Management

Use the `nb` CLI. Notes are stored in `~/.nb/<notebook-name>/` as markdown files with git tracking.
